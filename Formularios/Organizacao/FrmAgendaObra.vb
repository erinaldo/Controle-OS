...
Public Class FrmAgendaObra
        ...
        Public Sub PopularCalendario(AddDays As Integer, DataInicio As Date)
	      ...
	      conexao1("SELECT * FROM tbAgendaObras ORDER BY HoraMarcada DESC") 'RECUPERAR AS INFORMAÇÕES DO BANCO DE DADOS
		    ...
		    If Label1.Text = Evento.Data Then
			  ...
			  Select Case Evento.Tipo
				...
				Case = "Visita"
				        Ico = 2
			  End Select
			  l1.Items.Add(Evento.Descricao & " às " & Evento.Hora.ToString("HH:mm"), ico).SubItems.Add(Evento.EntregaID)
		    End If
		    ...
		    If Label2.Text = Evento.Data Then
			  Select Case Evento.Tipo
				...
				Case = "Visita"
				        Ico = 2
			  End Select
			  l2.Items.Add(Evento.Descricao & " às " & Evento.Hora.ToString("HH:mm"), Ico).SubItems.Add(Evento.EntregaID)
		    End If
		    ...
		    If Label3.Text = Evento.Data Then
			  Select Case Evento.Tipo
				...
				Case = "Visita"
				        Ico = 2
			  End Select
			  l3.Items.Add(Evento.Descricao & " às " & Evento.Hora.ToString("HH:mm"), Ico).SubItems.Add(Evento.EntregaID)
		    End If
		    ...
		    If Label4.Text = Evento.Data Then
			  Select Case Evento.Tipo
				...
				Case = "Visita"
				        Ico = 2
			  End Select
			  l4.Items.Add(Evento.Descricao & " às " & Evento.Hora.ToString("HH:mm"), Ico).SubItems.Add(Evento.EntregaID)
		    End If
		    ...
		    If Label5.Text = Evento.Data Then
			  Select Case Evento.Tipo
				...
				Case = "Visita"
				        Ico = 2
			  End Select
			  l5.Items.Add(Evento.Descricao & " às " & Evento.Hora.ToString("HH:mm"), Ico).SubItems.Add(Evento.EntregaID)
		    End If
		    ...
		    If Label6.Text = Evento.Data Then
			  Select Case Evento.Tipo
				...
				Case = "Visita"
				        Ico = 2
			  End Select
			  l6.Items.Add(Evento.Descricao & " às " & Evento.Hora.ToString("HH:mm"), Ico).SubItems.Add(Evento.EntregaID)
		    End If
		    ...
		    If Label7.Text = Evento.Data Then
			  Select Case Evento.Tipo
				...
				Case = "Visita"
				        Ico = 2
			  End Select
			  l7.Items.Add(Evento.Descricao & " às " & Evento.Hora.ToString("HH:mm"), Ico).SubItems.Add(Evento.EntregaID)
		    End If
	      End While
	      Desconexao1()
        End Sub
        ...
        Public Function PreencherTxt(EntregaID As Double)
	      ...
	      'INFO ENTREGA
	      Dim dr1 As OleDbDataReader = GetDR_semRead("SELECT * FROM tbAgendaObras WHERE EntregaID=" & EntregaID) 'INFO ENTREGA E STATUS
	      dr1.Read()
        ...
        Private Sub l1_MouseClick(sender As Object, e As MouseEventArgs) Handles l1.MouseClick 'RECUPERAR INFORMAÇÕES DO LEMBRETE DE ENTREGA
	      ...
	      lstLastClick = "l1"
        End Sub
        Private Sub l2_MouseClick(sender As Object, e As MouseEventArgs)  'RECUPERAR INFORMAÇÕES DO LEMBRETE DE ENTREGA
	      On Error Resume Next
        ...
        Private Sub btnShowItens_Click(sender As Object, e As EventArgs)
        ...
        Private Sub btnExcluirAgendamento_Click(sender As Object, e As EventArgs)
        ...
        Public Sub ApagarLembrete(ByRef L As ListView)
	      ...
	      Select Case L.SelectedIndices.Count
		    ...
		    Case = 1
			  pbCalen.Value = 30
			  InstrucaoDireta("DELETE * FROM tbAgendaObras WHERE EntregaID=" & CDbl(L.SelectedItems(0).SubItems(1).Text))
			  pbCalen.Value = 50
        ...
        End Sub
        Private Sub btnAddLembrete_Click(sender As Object, e As EventArgs)
