...
Public Class FrmLogin
    ...
    Private Sub linkCadastroUsuario_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lkCadastroUsuario.LinkClicked
...
prox:
    ...
    Private Sub txtUsuario_PaddingChanged(sender As Object, e As EventArgs) Handles txtUsuario.PaddingChanged
