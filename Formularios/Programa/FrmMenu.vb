...
Public Class FrmMenu
    ...
    End Sub
        ...
        Private Sub OSToolStripMenuItem_Click(sender As Object, e As EventArgs)
        ...
        Private Sub RELATÓRIOSToolStripMenuItem1_Click(sender As Object, e As EventArgs)
        ...
        Private Sub AGENDAToolStripMenuItem1_Click(sender As Object, e As EventArgs)
                FrmAgendaEntregas.ShowDialog()
        End Sub
    ...
    Private Sub btnLogout_Click(sender As Object, e As EventArgs) Handles btnLogout.Click
        ...
        Private Sub btnVisitas_Click(sender As Object, e As EventArgs)
                FrmListaVisita.Show()
        End Sub

        Private Sub btnVisita_Click(sender As Object, e As EventArgs) Handles btnVisita.Click
                FrmListaVisita.ShowDialog()
        End Sub

    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
                FrmNovoOrcamento.ShowDialog()
        End Sub
